...
def search_action_word(doc_id):
	...
	try:
		...
		# call search action keywords
		args = [doc_id]
		mysql_cursor.callproc( 'scin_db.pub_pw_action_word_exists', args )

		query = ("SELECT count(1) as count FROM scin_db.pub_pw_action_word_temp")
